...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('proxy_holder')
    ...
    rtab_remappings=[
          ('rgb/image', '/depth_camera_controller/image_raw'),
          ('rgb/camera_info', '/depth_camera_controller/camera_info'),
          ('depth/image', '/depth_camera_controller/depth/image_raw'),
          ('imu', '/imu'),
    ...
    pointcloud_to_lasercan_cmd = Node(
        package='pointcloud_to_laserscan', executable='pointcloud_to_laserscan_node',
        remappings=[('cloud_in', '/depth_camera_controller/points'),
                    ('scan', '/scan')],
        parameters=[{
            'target_frame': 'cloud',
